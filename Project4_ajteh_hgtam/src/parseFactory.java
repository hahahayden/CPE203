...
//    private static final String BGND_KEY = "background";
    ...
    private static final int VOLCANO_NUM_PROPERTIES=5;
    private static final int VOLCANO_ID = 1;
    private static final int VOLCANO_COL = 2;
    private static final int VOLCANO_ROW = 3;
    private static final int VOLCANO_ACTION_PERIOD = 4;
...
//    public static boolean parseVolcano(String [] properties, ImageStore imageStore, WorldModel world)
//    {
//        if (properties.length == VOLCANO_NUM_PROPERTIES)
//        {
//            Point pt = new Point(Integer.parseInt(properties[VOLCANO_COL]),
//                    Integer.parseInt(properties[VOLCANO_ROW]));
//            Volcano entity = createFactory.createVolcano(properties[VOLCANO_ID],
//                    Integer.parseInt(properties[VOLCANO_ACTION_PERIOD]),pt,
//                    imageStore.getImageList(VOLCANO_KEY));
//            world.tryAddEntity(entity,pt);
//        }
//
//        return properties.length == VEIN_NUM_PROPERTIES;
