...
public class PartOneTestCases
{
   ...
   public void testPerimCircle(){
      ...
      double perimeterCircle=Util.perimeter(circle1);
      assertEquals(31.4159265359,perimeterCircle,DELTA);

   }
   @Test
   public void testPerimRect(){
      Point topLeft=new Point(0.0,0.0);
      Point bottomRight=new Point(10.0,-10.0);
      Rectangle rect1=new Rectangle(topLeft,bottomRight);
      double perimRect=Util.perimeter(rect1);
      assertEquals(40.0,perimRect,DELTA);
   }
   @Test
   public void testPerimPoly(){
      ...
      pointList.add(new Point(0.0,1.0));
      Polygon polygon1= new Polygon(pointList);
      double polyPerim=Util.perimeter(polygon1);
      assertEquals(4.0,polyPerim,DELTA);
   }
   @Test
   public void testBigger()
   {
      List<Point> lst = new ArrayList<Point>(); // why not ArrayList<point>
