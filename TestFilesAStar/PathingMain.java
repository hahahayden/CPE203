  ...
  // private PathingStrategy strategy = new SingleStepPathingStrategy();
   ...
   public void keyPressed()
   {
      if (key == ' ')
      {
         ...
         foundPath = findGoal2(wPos, goalPos, grid, path);
   ...
   private boolean findGoal2(Point pos, Point goal, GridValues[][] grid, List<Point> path)
   {
      List<Point> points;
      points = strategy.computePath(pos, goalPos,
                              p ->  withinBounds(p, grid) && grid[p.y][p.x] != GridValues.OBSTACLE,
