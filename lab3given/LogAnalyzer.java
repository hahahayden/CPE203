                                                   ...
                                                   final Map<String, List<Buy>> buysFromSession)
   {
      ...
      List<String> listofsessionswithpurchases = new LinkedList<>();
         ...
         for (String sessionIDS : i)
         {
            ...
            //goes through each session id and checks if it is purchased
            List<Buy> purchases = buysFromSession.get(sessionIDS);

            //if returns something that isn't empty
            if ( purchases != null)
            {
               //add the sessionID
      ...
      //goes through the purchased list
      for (String session : listofsessionswithpurchases)
      {
         ...
         for (Buy purchase : buysFromSession.get(session))
         {
            ...
            String productIDs = purchase.getProductID();
            ...
            //total price of items for the sessions that were purchased
                        ...
                        if (listofbuys != null)
                        {
                           ...
                           for (Buy product : listofbuys)
                           {
                              ...
                              if (!listofproducts.contains(product))
                              {
                                 ...
                                 listofproducts.add(product.getProductID());
                              }
               }
            }
         }
